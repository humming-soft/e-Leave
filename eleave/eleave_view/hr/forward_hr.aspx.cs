    ...
    public partial class forward_hr : System.Web.UI.Page
    {
            ...
            foreach (GridViewRow row in grd_forward.Rows)
            {
                ...
                if (cbox.Checked == true)
                {
                    ...
                    if (r == 1)
                    {
                        ...
                        mailbody = "<table style='width: 850px; border-color: black;' border='1' cellspacing='0' cellpadding='0'><tbody><tr><td colspan='9'><br />&nbsp;Dear Sir / Madam,<br /><br />&nbsp;Leave application submitted by <strong>" + row.Cells[2].Text.ToString() + "</strong> has been forwarded to you on <strong><br>&nbsp;" + DateTime.Now.ToString("dd/MM/yyyy") + ".</strong> The details are as follows.<br /><br /></td></tr><tr><td colspan='9'><br /><p>&nbsp;Name: " + row.Cells[2].Text.ToString() + "</p><p>&nbsp;Department: " + row.Cells[3].Text.ToString() + "</p><p>&nbsp;Designation: " + row.Cells[4].Text.ToString() + "</p><p>&nbsp;Leave Type: " + row.Cells[5].Text.ToString() + "</p><p>&nbsp;Period: " + row.Cells[7].Text.ToString() + "</p><p>&nbsp;Reason: " + row.Cells[8].Text.ToString() + "</p><p>&nbsp;click<a href="+ url2 +"> here </a>to login into the application (UOA)</p><p>&nbsp;click<a href="+ url +"> here </a>to login into the application</p></td></tr><tr><td align='center'><p style='color: blue;'>This is a system generated response. Please do not respond to this email id.</p></td></tr></tbody></table><p><br /><br />Regards,<br />Team e-leave</p>";
                        bool check = SendWebMail(toemail, "Leave Application Notification", mailbody, "", "", "info@hummingsoft.com.my");
                        //bool check = SendWebMail(toomail, "Leave Application Notification", mailbody, "", "", "info@hummingsoft.com.my");
                        if (check == true)
                        {
                            f = 0;
                        }
        ...
        protected void lnkforward_Click(object sender, EventArgs e)
        {
            ...
            if (r == 1)
            {
                fetch_mail_details();
                //string toomail = "ancy@hummingsoft.com.my";
                mailbody = "<table style='width: 850px; border-color: black;' border='1' cellspacing='0' cellpadding='0'><tbody><tr><td colspan='9'><br />&nbsp;&nbsp;Dear Sir / Madam,<br /><br />&nbsp;&nbsp;Leave application submitted by <strong>" + row.Cells[2].Text.ToString() + "</strong> has been forwarded to you on <strong><br/>&nbsp;&nbsp;" + DateTime.Now.ToString("dd/MM/yyyy") + ".</strong> The details are as follows.<br /><br /></td></tr><tr><td colspan='9'><br /><p>&nbsp;</p><p>&nbsp;&nbsp;Name: " + row.Cells[2].Text.ToString() + "</p><p>&nbsp;&nbsp;Department: " + row.Cells[3].Text.ToString() + "</p><p>&nbsp;&nbsp;Designation: " + row.Cells[4].Text.ToString() + "</p><p>&nbsp;&nbsp;Leave Type: " + row.Cells[5].Text.ToString() + "</p><p>&nbsp;&nbsp;Period: " + row.Cells[7].Text.ToString() + "</p><p>&nbsp;&nbsp;Reason: " + row.Cells[8].Text.ToString() + "</p><p>&nbsp;&nbsp;click<a href=" + url2 + "> here </a>to login into the application (UOA)</p><p>&nbsp;&nbsp;click<a href=" + url + "> here </a>to login into the application</p></td>/tr><tr><td align='center'><p style='color: blue;'>This is a system generated response. Please do not respond to this email id.</p></td></tr></tbody></table><p><br /><br />Regards,<br />Team e-leave</p>";
        ...
        protected void lnkreject_Click(object sender, EventArgs e)
        {
            ...
            if (r == 1)
            {
                mailbody = "<table style='width: 850px; border-color: black;' border='1' cellspacing='0' cellpadding='0'><tbody><tr><td colspan='9'><br />Dear " + row.Cells[2].Text.ToString() + ",<br /><br />Leave application submitted by you is <strong>Rejected </strong> on " + DateTime.Now.ToString("dd/MM/yyyy") + ". The details are as follows.<br /><br /></td></tr><tr><td colspan='9'><br /><p>Name: " + row.Cells[2].Text.ToString() + "</p><p>Department: " + row.Cells[3].Text.ToString() + "</p><p>Designation: " + row.Cells[4].Text.ToString() + "</p><p>Leave Type: " + row.Cells[5].Text.ToString() + "</p><p>Period: " + row.Cells[7].Text.ToString() + "</p><p>Reason: " + row.Cells[8].Text.ToString() + "</p><p>click<a href=" + url2 + "> here </a>to login into the application (UOA)</p><p>click<a href=" + url + "> here </a>to login into the application</p></td></tr><tr><td align='center'><p style='color: blue;'>This is a system generated response. Please do not respond to this email id.</p></td></tr></tbody></table><p><br /><br />Regards,<br />Team e-leave</p>";
            ...
            foreach (GridViewRow row in grd_forward.Rows)
            {
                ...
                if (cbox.Checked == true)
                {
                    if (txtbreason.Text != "")
                    {
                        ...
                        if (r == 1)
                        {
                            mailbody="<table style='width: 850px; border-color: black;' border='1' cellspacing='0' cellpadding='0'><tbody><tr><td colspan='9'><br />Dear " + row.Cells[2].Text.ToString() + ",<br /><br />Leave application submitted by you is <strong>Rejected </strong> on " + DateTime.Now.ToString("dd/MM/yyyy") + ". The details are as follows.<br /><br /></td></tr><tr><td colspan='9'><br /><p>&nbsp;</p><p>Name: " + row.Cells[2].Text.ToString() + "</p><p>Department: " + row.Cells[3].Text.ToString() + "</p><p>Designation: " + row.Cells[4].Text.ToString() + "</p><p>Leave Type: " + row.Cells[5].Text.ToString() + "</p><p>Period: " + row.Cells[7].Text.ToString() + "</p><p>Reason: " + row.Cells[8].Text.ToString() + "</p><p>click<a href="+ url2 +"> here </a>to login into the application (UOA)</p><p>click<a href="+ url +"> here </a>to login into the application</p></td></tr><tr><td align='center'><p style='color: blue;'>This is a system generated response. Please do not respond to this email id.</p></td></tr></tbody></table><p><br /><br />Regards,<br />Team e-leave</p>";
